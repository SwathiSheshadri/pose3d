...
exp_name = 'Rubikscube_DLC2d'; % ./AllExperiments/Experiment1; **To be different for every new experiment**
...
primary2D_datafullpath     = {'./Demo_Data/rubiks4-0000DeepCut_resnet50_RubiksCubeJul27shuffle1_600000.csv'}; %copy and paste the full path to your csv files generated by DLC
...
secondary2D_datafullpath = [{'./Demo_Data/rubiks1-0000DeepCut_resnet50_RubiksCubeJul27shuffle1_600000.csv'}; 
    {'./Demo_Data/rubiks2-0000DeepCut_resnet50_RubiksCubeJul27shuffle1_600000.csv';};
    {'./Demo_Data/rubiks3-0000DeepCut_resnet50_RubiksCubeJul27shuffle1_600000.csv'}; 
    {'./Demo_Data/rubiks5-0000DeepCut_resnet50_RubiksCubeJul27shuffle1_600000.csv'}];

% havelabeledvideos = 1; %for this demo, labelled videos have been provided in a compact .mat format 

% pathlabeledvideos = [{'/Users/ssheshadri/Mac_local_files/JOSS_data/NewResults/cropped_rubiks1-0000DeepCut_resnet50_RubiksCubeJul27shuffle1_600000_labeled.mp4'}; 
%     {'/Users/ssheshadri/Mac_local_files/JOSS_data/NewResults/cropped_rubiks2-0000DeepCut_resnet50_RubiksCubeJul27shuffle1_600000_labeled.mp4';};
%     {'/Users/ssheshadri/Mac_local_files/JOSS_data/NewResults/cropped_rubiks3-0000DeepCut_resnet50_RubiksCubeJul27shuffle1_600000_labeled.mp4'}; 
%      {'/Users/ssheshadri/Mac_local_files/JOSS_data/NewResults/cropped_rubiks4-0000DeepCut_resnet50_RubiksCubeJul27shuffle1_600000_labeled.mp4'}; 
%     {'/Users/ssheshadri/Mac_local_files/JOSS_data/NewResults/cropped_rubiks5-0000DeepCut_resnet50_RubiksCubeJul27shuffle1_600000_labeled.mp4'}];
