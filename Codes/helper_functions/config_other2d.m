...
primary2D_datafullpath     = {'./DemoData/Rubikscube_other2d_Primary_CollectedData_Swathi.csv'}; %copy and paste the full path to your csv files generated by DLC
...
secondary2D_datafullpath = [{'./DemoData/Rubikscube_other2d_Secondary1_CollectedData_Swathi.csv'}; 
    {'./DemoData/Rubikscube_other2d_Secondary2_CollectedData_Swathi.csv';};
    {'./DemoData/Rubikscube_other2d_Secondary3_CollectedData_Swathi.csv'}; 
    {'./DemoData/Rubikscube_other2d_Secondary4_CollectedData_Swathi.csv'}];
