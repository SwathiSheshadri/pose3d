...
primary2D_datafullpath     = {'/Users/ssheshadri/iMac_local/sandbox/DemoData/rubiks_primary-0000DeepCut_resnet50_RubiksCubeJul27shuffle1_600000.csv'}; 
...
secondary2D_datafullpath = [{'/Users/ssheshadri/iMac_local/sandbox/DemoData/rubiks_secondary1-0000DeepCut_resnet50_RubiksCubeJul27shuffle1_600000.csv'};...
                            {'/Users/ssheshadri/iMac_local/sandbox/DemoData/rubiks_secondary2-0000DeepCut_resnet50_RubiksCubeJul27shuffle1_600000.csv'};...
                            {'/Users/ssheshadri/iMac_local/sandbox/DemoData/rubiks_secondary3-0000DeepCut_resnet50_RubiksCubeJul27shuffle1_600000.csv'};...
                            {'/Users/ssheshadri/iMac_local/sandbox/DemoData/rubiks_secondary4-0000DeepCut_resnet50_RubiksCubeJul27shuffle1_600000.csv'}];
...
% images
folderwithpngs = '/Users/ssheshadri/iMac_local/sandbox/TestExperiments1/Imagesforcalibration/';
...
path_to_2Dtracked_video = '/Users/ssheshadri/iMac_local/JOSS_alldata/RubiksVideos/rubiks1-0000DeepCut_resnet50_RubiksCubeJul27shuffle1_600000_labeled.mp4'; %full path of the 2D tracked video you want to visualize alongside 3D tracked results

color_bw = 1; % 1 for color and 0 for black and white
nskip = 1; %min value nskip can take is 1, increase this when you have long recordings or high res images to increase speed of plotting (plots results from every nskip frames)
...
ground_truth = [57; 57; 57; 57; 57; 57; 57; 57; 57; 57; 57; 57] ; %enter line segment lengths ( refer to the skeleton and ensure to have as many length entries here as there are lines in the skeleton )
